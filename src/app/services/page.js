...
export const metadata = {
    title: "Our Services | Financial Advisory, Taxation & Compliance | Folio First",
    description: "Explore our expert financial consulting services: taxation, compliance, audit, corporate law, dematerialisation, and more. Free consultation available.",
    alternates: {
        canonical: `${siteConfig.url || 'https://foliofirstconsulting.com'}/services`,
    },
    openGraph: {
        title: "Our Services | Financial Advisory, Taxation & Compliance",
        description: "Explore expert financial consulting services: taxation, compliance, audit, corporate law, and advisory.",
    ...
    twitter: {
        ...
        description: "Taxation, compliance, audit, corporate law and more — expert financial consulting services.",
    },
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-base md:text-xl lg:text-2xl text-gray-400 max-w-2xl mx-auto leading-relaxed font-light px-2">
                            Comprehensive advisory by a dedicated team of CAs and lawyers — from taxation and compliance to audit, NRI services, and corporate law.
                        </p>
                    </div>
                </div>
            </section>
                            ...
                            >
                                ...
                                <div className="w-full lg:w-1/2 text-center lg:text-left">
                                    ...
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-3 bg-[#232323] hover:bg-[#d5ad5c] text-white h-14 md:h-16 rounded-full px-8 md:px-10 text-base md:text-lg font-bold shadow-[0_10px_20px_rgba(35,35,35,0.15)] hover:shadow-[0_15px_30px_rgba(213,173,92,0.3)] hover:-translate-y-1 transition-all group w-full sm:w-auto justify-center"
                                    >
                                        Explore Details
